...
class Student:
    def __init__(self,root):
        ...
        # 1st
        img_1=Image.open("college images\download (1).jpg")
        ...
        # 2st
        img_2=Image.open("college images\images (4).jpg")
        ...
        # 3st
        img_3=Image.open("college images\download (3).jpg")
        ...
        img_4=Image.open("college images\images (3).jpg")
        ...
        # img
        img_5=Image.open("college images\images (4).jpg")
        ...
        com_txtcourse_std["value"]=("Select Course","FE","TE","BE")
        ...
        id_entry=ttk.Entry(std_lbl_class_frame,textvariable=self.var__std_id,font=("arial",12,"bold"),width=22)
        ...
        # img
        img_6=Image.open("college images\images (4).jpg")
        img_6=img_5.resize((790,200),Image.ANTIALIAS)
        self.photoimg_5=ImageTk.PhotoImage(img_6)

        my_img=Label(DataRightFrame,image=self.photoimg_4,bd=2,relief=RIDGE)
    ...
    def add_data(self):
        if (self.var_dep.get()=="" or self.var_email.get()==""):
            ...
            try:
                conn=mysql.connector.connect(host="localhost",user="root",password="User@22091999",database="sys")
                ...
                messagebox.showerror("Error",f"Due To:{str(ess)}",parent=self.root)
    ...
    def get_cursor(self,event=""):
        ...
        self.var__std_id.set(data[4])
        self.var_std_name.set(data[5])
        self.var_div.set(data[6])
        self.var_roll.set(data[7])
        self.var_gender.set(data[8])
        self.var_dob.set(data[9])
        self.var_email(data[10])
